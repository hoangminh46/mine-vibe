...
### Clarified
- **Workflow Catalog Source of Truth:** The current shipped workflow set is the one present in `workflows/coding/` and `workflows/system/`.
...
- `/mine-update` workflow for checking and installing updates
